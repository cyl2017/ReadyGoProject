...
/*
void (*KVO_action2)(id, SEL, id, id) =  (void(*)(id,SEL,id,id))objc_msgSend;

void (*KVO_action3)(id, SEL, id, id,id) =  (void(*)(id,SEL,id,id,id))objc_msgSend;
*/
...
- (void)observeValueForKeyPath:(NSString*)keyPath ofObject:(id)object change:(NSDictionary*)change context:(void*)context
{
    ...
    {
        //KVO_action2(_target,_selector,_sourceObject,change[NSKeyValueChangeNewKey]);
    }
    else if (_type == kKVOPropertyType_OLD)
    {
       // KVO_action3(_target,_selector,_sourceObject,change[NSKeyValueChangeNewKey], change[NSKeyValueChangeOldKey]);
    }
}
@end
