...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        {
            rect.origin.y = kScreen_Width*135/320 + 10;
        }
        else
        {
            rect.origin.y = kScreen_Width*135/320-30;//rect.size.height - 38;
        }

        rect.origin.x =kScreen_Width*0.38;
        rect.size.height = 30;
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(kScreen_Width/4, self.frame.size.height-20, kScreen_Width/2,self.frame.size.height/10)];
